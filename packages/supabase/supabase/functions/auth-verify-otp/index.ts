...
async function createJWT(payload: Omit<JWTPayload, 'iat' | 'exp'>): Promise<string> {
...
async function sendWelcomeEmail({ to, userName }: { to: string, userName: string }): Promise<void> {

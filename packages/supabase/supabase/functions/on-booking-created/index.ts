...
async function sendEventReminderEmail({ to, bookerName, pastorName, eventTitle, date, time, duration, pastorAlias, bookingId }) {
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://pastoragenda.com/booking/cancel/${bookingId}" 
...
async function sendPastorNotificationEmail({ to, pastorName, bookerName, bookerEmail, eventTitle, date, time, duration, description, bookingId }) {
  ...
  try {
    ...
    try {
      await sendPastorNotificationEmail({
        ...
        time: formattedTime,
        duration: eventType.duration,
        description: record.booker_description || '',
        bookingId: record.id
      });
